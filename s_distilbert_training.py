...
dataset = load_dataset("json", data_files="/content/s_distilbert_data_fixed.json")
...
trainer.save_model("/content/distilbert_s_data")

# Uloženie tokenizera
tokenizer.save_pretrained("/content/distilbert_s_data")


# Zabalenie modelu do ZIP archívu
!zip -r distilbert_s_data.zip /content/distilbert_s_data/


from google.colab import files

# Stiahnutie ZIP archívu do lokálneho prostredia
files.download("distilbert_s_data.zip")