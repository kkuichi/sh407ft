...
# Načítanie syntetického datasetu vo formáte JSON
dataset = load_dataset("json", data_files="/content/s_flan_dataset_fixed.json")
...
trainer.save_model("/content/flan_t5_s_data")

# Uloženie tokenizera
tokenizer.save_pretrained("/content/flan_t5_s_data")

# Zabalenie modelu do ZIP
!zip -r flan_t5_s_data.zip /content/flan_t5_s_data/


from google.colab import files

# Stiahnutie ZIP do lokálneho prostredia
files.download("flan_t5_s_data.zip")